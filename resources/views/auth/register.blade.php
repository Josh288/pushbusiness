              ...
              <form>
                ...
                <div class="row">
                  <div class="form-outline mb-3">
                      <input type="name" id="form3Example1" class="form-control  @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                      @error('name')
                ...
                <!-- Correo del usuario -->
                <div class="form-outline mb-3">
                  <input type="mail" id="form3Example4" class="form-control" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email""
                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                      <div class="form-outline">
                        <input type="password" id="form3Example1" class="form-control" @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" />
                        @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        @enderror
                    ...
                    @enderror
                        <label class="form-label" for="form3Example2">{{ __('Confirmar contraseña') }} </</label>
                      </div>
                    </div>
                  </div>
