                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('product.destroy', $product->id) }}" method="POST">
                                                    <button type="button" class="btn btn-sm btn-primary btnshow"
                                                        value={{ $product->id }}><i class="fa fa-fw fa-eye"></i></button>
                                                    <button type="button" class="btn btn-sm btn-success btnedit"
                                                        value={{ $product->id }}><i class="fa fa-fw fa-edit"></i></button>
                                                    @csrf

                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm bg-pink-700"><i
                    ...
                    <div class="modal-body">
                        <div class="box-body row">
                            ...
                            <div class="form-group mt-3 mb-3">
                                ...
                                <input type="number" class="form-control" name="price-product1" id="price-product1"
                                    required>
                            </div>
                            ...
                            <div class="form-group mt-3 mb-3">
                                ...
                                <input type="text" class="form-control" name="color-product1" id="color-product1"
                                    required>
                            </div>
                ...
                <div class="modal-body">
                    <div class="box-body row">
                        <div class="form-group mt-3 mb-3">
                            ...
                            <input type="text" class="form-control" name="name-product2" id="name-product2" required
                                readonly>
                        </div>

                        <div class="form-group  mt-3 mb-3">
                            <label for="des-product2" class="form-label">Descripcion</label>
                            <textarea name="des-product2" id="des-product2" cols="30" rows="5" class="form-control" required
                                readonly></textarea>
                        </div>

                        <div class="form-group mt-3 mb-3">
                            <label for="price-product2" class="form-label">Precio</label>
                            <input type="text" class="form-control" name="price-product2" id="price-product2"
                                required readonly>
                        </div>

                        <div class="form-group mt-3 mb-3">
                            <label for="tall-product2">Talla</label>
                            <input type="text" class="form-control" name="tall-product2" id="tall-product2" required
                                readonly>
                        </div>

                        <div class="form-group mt-3 mb-3">
                            <label for="color-product2" class="form-label">Color</label>
                            <input type="text" class="form-control" name="color-product2" id="color-product2"
                                required readonly>
                        </div>

                        <div class="form-group mt-3 mb-3">
                            <label for="avilable-product2">Disponibilidad</label>
                            <input type="text" name="avilable-product2" id="avilable-product2" class="form-control"
                                required readonly>
                        </div>

                        <div class="form-group mt-3 mb-3">
                            <label for="ammount-product2">Cantidad</label>
                            <input type="text" name="amount-product2" id="amount-product2" class="form-control"
                                required readonly>
                        </div>

                        <div class="form-group mt-3 mb-3">
                            <label for="status-product2">Estado</label>
                            <input type="text" name="status-product2" id="status-product2" class="form-control"
                                required readonly>
                        </div>

                        <div class="form-group mt-3 mb-3">
                            <label for="sector-product2">Sector</label>
                            <input type="text" name="sector-product2" id="sector-product2" class="form-control"
                                required readonly>
                        </div>
